(defproject counter "0.1.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.9.0"]
                 ...
                 [jay.mars/market-messages "0.2"]
                 [org.postgresql/postgresql "42.2.5"]
                 [clj-postgresql "0.7.0"]
                 [org.clojure/java.jdbc "0.7.8"]
                 [org.clojure/core.specs.alpha "0.1.10" :exclusions [[org.clojure/clojure] [org.clojure/specs.alpha]]]
  ...
  :junit ["src/test/java"]
  :aot :all
  :profiles {:server {:main jay.mars.market.App
